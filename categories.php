...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "DELETE FROM categories where id in (" . $checkArray . ")";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>Category Name</th>
                      <th>Status</th>
                      <th>Action<a href='cat_add.php'><span style='color:green'><i
                              class="fas fa-plus-circle"></i></span></a></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td><input type='checkbox' value=" . $row['id'] . " name='checkedcategories[]' class='delete_check'></td>";
                        echo "<td><img src='" . $row['cat_img'] . "'' height='70'></td>";
                        ...
                        echo "<td><a href='cat_edit.php?id=" . $row['id'] . "'><span style='color:blue'><i class='fas fa-edit'></i></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a data-id='" . $row['id'] . "' href='javascript:;' data-toggle='modal' data-target='#exampleModalLong' class='delete_btn'><span style='color:red'><i class='fas fa-trash'></i></span></a></td>";
